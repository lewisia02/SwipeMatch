...
追加チェック項目:
- [ ] 画面一覧があり、各画面が対応機能とひも付いているか(トレーサビリティ)
- [ ] 画面遷移図があり、遷移トリガーが明記されているか
- [ ] 各画面にワイヤーフレームがあるか
- [ ] 状態設計(loading / empty / error / success / disabled)が網羅されているか
- [ ] 共通コンポーネントとデザイントークンが定義されているか
- [ ] レスポンシブ・アクセシビリティ方針があるか
